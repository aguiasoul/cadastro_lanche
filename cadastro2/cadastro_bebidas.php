...
if(isset($_POST["bebida"])){
    ...
    $mysqli->query("INSERT INTO cadastro_de_bebida (bebida, ingr, preco) values('$bebida', '$ingr', '$preco')") or
        die($mysqlierrno);
...
<div class="container">
    ...
    <form action="" method="post">
            <label for="">Nome da Bebida:</label>
            <input class="form-control" type="text" placeholder="Bebida" name="bebida" required>
